...
- [x] [189A](../../CF/problem/189A.cpp) // 除了起点应该初始化成-∞, 
## LCS最长公共子序列

## LIS最长上升子序列
-[x] [P1439](../../luogu/P1439.cpp)
- [x] [987C.cpp](../../CF/problem/987C.cpp) // 利用最优子结构来找最小值
...
- [ ] [670D1](../../CF/problem/670D1.cpp) // 二分
- [ ] [1201C](../../CF/problem/1201C.cpp) // 贪心+二分
- [ ] [1117C](../../CF/problem/1117C.cpp) // 位置二分+曼哈顿距离+前缀和
...
## 快速选择
$O(n)$的时间复杂度来选出第几大的元素
- [x] [P1923](../../luogu/P1923.cpp)
> stl: `nth_element(first, k, end)`

# 双指针
- [x] [P1638](../../luogu/P1638.cpp) 找到每个L的最优R不会漏最优解
- [x] [1354B](../../CF/problem/1354B.cpp) 双指针标准模板

# 哈希
$O(1)判断元素是否相等$
- [x] [P3370](../../luogu/P3370.cpp) 字符串哈希
- [ ] [P2852](../../luogu/P2852.cpp) 子串哈希
```cpp
string s = "abcde";
h[1] = "a";
h[2] = p * h[1] + "b" = ap + b;
h[3] = p * h[2] + "c" = ap^2 + bp + c;
h[4] = p * h[3] + "d" = ap^3 + bp^2 + cp + d;
...
## 康托展开
> 在N的全排列中，给字典序求全排列或者给全排列求字典
- [x] [P1088](../../luogu/P1088.cpp)
> 模板
- [x] [cantor](../../algorithm/cantor.cpp)
